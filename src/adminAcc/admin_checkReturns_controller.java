...
public class admin_checkReturns_controller implements Initializable {
			...
			if (mouseEvent.getClickCount() == 2) {
				...
				if (records != null) {
					...
					try {
						...
						FXMLLoader loader = new FXMLLoader(Objects.requireNonNull(getClass().getResource("/adminAcc/admin_return_material.fxml")));
						root = loader.load();
