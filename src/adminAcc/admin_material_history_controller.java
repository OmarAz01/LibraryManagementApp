...
public class admin_material_history_controller implements Initializable {
	...
	private void initializeHistoryTable() {
		...
		try {
			...
			psGetRecord = dbConnect.prepareStatement("SELECT * FROM records WHERE material_id = '" + admin_HP_controller.material.getMaterial_id() + "' AND returned_date <> 'Cancelled';");
