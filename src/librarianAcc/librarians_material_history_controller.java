...
public class librarians_material_history_controller implements Initializable {
	...
	private void initializeHistoryTable() {
		...
		try {
			...
			psGetRecord = dbConnect.prepareStatement("SELECT * FROM records WHERE material_id = '" + librarians_HP_controller.material.getMaterial_id() + "' AND returned_date <> 'Cancelled';");
