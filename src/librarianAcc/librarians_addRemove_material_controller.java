...
public class librarians_addRemove_material_controller implements Initializable {
		...
		add_btn.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				try {
					...
					FXMLLoader loader = new FXMLLoader(Objects.requireNonNull(getClass().getResource("/librarianAcc/librarians_add_material.fxml")));
					root = loader.load();
			...
			if (mouseEvent.getClickCount() == 2) {
				...
				if (material != null) {
					...
					try {
						...
						FXMLLoader loader = new FXMLLoader(Objects.requireNonNull(getClass().getResource("/librarianAcc/librarians_choice.fxml")));
						root = loader.load();
