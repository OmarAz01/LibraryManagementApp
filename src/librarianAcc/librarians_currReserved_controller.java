...
public class librarians_currReserved_controller implements Initializable {
			...
			if (mouseEvent.getClickCount() == 2) {
				...
				if (records != null) {
					...
					try {
						...
						FXMLLoader loader = new FXMLLoader(Objects.requireNonNull(getClass().getResource("/librarianAcc/librarians_issue_material.fxml")));
						root = loader.load();
