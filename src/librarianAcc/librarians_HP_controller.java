...
public class librarians_HP_controller implements Initializable {
			...
			if (mouseEvent.getClickCount() == 2) {
				...
				if (material != null) {
					...
					try {
						...
						FXMLLoader loader = new FXMLLoader(Objects.requireNonNull(getClass().getResource("/librarianAcc/librarians_material_history.fxml")));
						root = loader.load();
