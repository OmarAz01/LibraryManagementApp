...
public class members_signin_controller implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		button_login.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				try {
					Main.currUser = DB.logIn(event, tf_username.getText(), tf_password.getText(), "Member");
		...
		button_register.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				DB.changeScene(event, "/memberAcc/SignUp.fxml", "Sign Up");
